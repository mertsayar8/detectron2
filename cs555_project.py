...
!cp "/content/gdrive/My Drive/CS555 Project/PRImA Layout Analysis Dataset/Images/00001288.tif" "00001288.tif"

!pwd

!python demo/demo.py --config-file configs/DLA_mask_rcnn_R_101_FPN_3x.yaml --input "/content/detectron2-master/00001288.tif"  --output output_predicted5 --confidence-threshold 0.5 --opts MODEL.WEIGHTS "/content/model_final_trimmed.pth" MODEL.DEVICE cpu
